      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="space-y-4">
          <p className="text-lg leading-relaxed">
            ...
            <a href="https://abhikrc.com/" className="text-nus-blue hover:text-nus-orange underline">
              Abhik Roychoudhury
            </a>
            . In our research, we strive to enable <strong className="text-nus-orange">secure</strong> and{" "}
            ...
            <a href="https://nus-apr.github.io" className="text-nus-blue hover:text-nus-orange underline">
              Automated Program Repair
            </a>
            ,{" "}
            <a href="https://nus-tss.github.io/fuzzing/" className="text-nus-blue hover:text-nus-orange underline">
              Fuzzing
            </a>{" "}
            and Symbolic Execution.
            These analysis capabilities are added with agents to create more effective agents such as{" "}
            <a href="https://autocoderover.dev" className="text-nus-blue hover:text-nus-orange underline">
              <b>AutoCodeRover</b>
            </a>
            ...
            ({" "}
            <a href="https://www.youtube.com/watch?v=o8B6q8FNC70" className="text-nus-blue hover:text-nus-orange underline">
              WATCH VIDEO
            </a>
            )
            <br /><br />
            <b>
              <a href="https://spartan-nus.github.io/ai4code-roundtable">
